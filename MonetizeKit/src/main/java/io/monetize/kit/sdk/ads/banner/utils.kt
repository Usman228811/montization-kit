...
import com.google.android.libraries.ads.mobile.sdk.banner.AdSize.Companion.getCurrentOrientationAnchoredAdaptiveBannerAdSize
import com.google.android.libraries.ads.mobile.sdk.banner.AdSize.Companion.getLargeAnchoredAdaptiveBannerAdSize
...
fun getAdaptiveSize(activity: Activity): AdSize {
    return getCurrentOrientationAnchoredAdaptiveBannerAdSize(activity, adWidth(activity))
}

fun getLargeAnchored(activity: Activity): AdSize {
    return getLargeAnchoredAdaptiveBannerAdSize(activity, adWidth(activity))
}