...
class PurchaseSubscriptionUseCase private constructor(
    ...
    operator fun invoke(activity: Activity,product: ProductDetails,onUserDismissedPaywall: (() -> Unit)?) = repository.purchaseProduct(activity, product, onUserDismissedPaywall)
